const STRINGS = {
  en: {
    ...
    nav_shop: "Shop",
    footer: "Non-profit student project. Images and descriptions come from the",
    ...
    welcome_draws: "Use the Shop to perform draws and try to unlock new rare models.",
    welcome_collection_t: "Collection",
    welcome_collection: "Browse the full Catalog to discover every existing model, then head to your Inventory to manage and admire the ones you own.",
  ...
  fr: {
    ...
    nav_shop: "Boutique",
    footer: "Projet pédagogique à but non lucratif. Les images et descriptions proviennent du",
    ...
    welcome_draws: "Utilisez la Boutique pour effectuer des tirages et tenter de débloquer de nouveaux modèles rares.",
    welcome_collection_t: "Collection",
    welcome_collection: "Explorez le Catalogue complet pour découvrir tous les modèles existants, puis accédez à votre Inventaire pour gérer et admirer ceux que vous possédez.",
